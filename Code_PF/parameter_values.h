...
using reaction_norm = std::array<double,2>;
    ...
    constexpr static double mu_t{0}; // for damage transmission locus
    constexpr static double sd_mu{0.5};
    constexpr static double mu_h{0.01}; // for harvest (division of resources between cells)

    // forage parameters
// for harvest (division of resources between cells)
    // forage parameters
 constexpr static double forage_max{6.0};
    constexpr static double q_f{1}; // half-max
   ...
   // constexpr static double d0a{1000.0}; 
    ...
    constexpr static double b_svg{0.08}; // here
    // max damage to which max-damage allele corresponds
    constexpr static double d_max{4.0};
...
struct Pop_params{
    constexpr static unsigned long size{1000000};

    // cell resources in generation 0
    constexpr static double init_resources{3.0};

};

// nr of traits to calc stats for
constexpr static unsigned n_traits{45};
constexpr static unsigned long n_timesteps{5000};
